//ony registered user should be able to see hello world

//signup-login and verify- if true- create a token number then return it and paste as post then display    
...
//only admin token enables verification
